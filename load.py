...
class MongoDB:
    ...
    # TODO: Adapt below to be for SQL Server instead of Mongo DB
    ...
    def __init__(self, user, password, host, db_name, port='27017', authSource='admin'):
        ...
        self.uri = 'mongodb://' + self.user + ':' + self.password + '@' + self.host + \
            ':' + self.port + '/' + self.db_name + '?authSource=' + self.authSource
        try:
